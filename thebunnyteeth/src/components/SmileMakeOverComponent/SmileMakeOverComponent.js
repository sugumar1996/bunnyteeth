                                        ...
                                        <div className="object_content maintain_div">
                                            <div className="about_us_image treatment_banner ">
                                                <div className="inner_image_wrap mb-3">
                                                    <img src={baseImagePath('thumbnails/theme26.jpg')} class="custom_img border_radius_10PX"
                        ...
                        <div className="row">
                            <div className="col-lg-12">
                                <header className="maintain_div mb_30">
                                    <h3 className="h3_title montserrat_font position-relative">Smile Makeover services
                                    </h3>
                                </header>
                                <div className="row">
                                        ...
                                        <div className="ds_card maintain_div">
                                            <div className="ds_card_inner maintain_div">
                                                <article className="main_article maintain_div text-center">
                                                    ...
                                                    <h4 className="h4_title text-center text_color montserrat_font" style={{ textTransform: "uppercase" }}>Cosmetic Dentistry</h4>
                                                </article>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="ds_card maintain_div">
                                            <div className="ds_card_inner maintain_div">
                                                <article className="main_article maintain_div text-center">
                                                    ...
                                                    <h4 className="h4_title text-center text_color montserrat_font" style={{ textTransform: "uppercase" }}>Clear Aligners / Invisible Braces</h4>
                                                </article>
                                            </div>
                                        </div>
                                    </div>
